          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="text-center">จัดการบริการ</h5>
              </div>
              <div class="card-body">
                <!-- Button -->
                <div class="row justify-content-end">
                  <div class="col-xl-3 col-md-6 mb-2">
                    <select class="form-control form-control-sm"
                      ...
                      ?>
                      <option value="service.php?cat=<?php echo $row['cat_id'] ?>" <?php if(@$_GET['cat'] == $row['cat_id']) echo 'selected' ?>><?php echo $row['cat_name'] ?></option> 
                      <?php
                        endforeach;
                      ?>
                    </select>
