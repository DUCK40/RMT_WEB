...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2019 at 05:55 PM
...
--
-- Table structure for table `ex_customer`
--

CREATE TABLE `ex_customer` (
  `ct_id` int(11) NOT NULL,
  `ct_name` varchar(100) NOT NULL,
  `ct_phone` varchar(50) NOT NULL,
  `ct_car` varchar(50) NOT NULL,
  `ct_address` varchar(100) NOT NULL,
  `ct_status` int(1) DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ex_customer`
--

INSERT INTO `ex_customer` (`ct_id`, `ct_name`, `ct_phone`, `ct_car`, `ct_address`, `ct_status`) VALUES
(1, 'สุเทพ', '08455500', 'honda cbr1000', 'บางเสา 10/59 สป.', 1),
(2, 'ประยุทธ์', '090000454', 'cbr 650 f', 'บางนา 77/99', 2);
...
(1, 'สาขาบางปู', 1, '2018-11-15 10:33:54', '2019-01-12 14:21:08'),
(2, 'สาขาบางนา', 1, '2018-11-15 10:34:45', '2019-01-12 14:21:28'),
(3, 'สาขาบางบ่อ', 1, '2018-11-15 11:00:27', '2019-01-12 14:21:28');
...
(3, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-12 13:30:19'),
(4, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-12 15:42:23'),
(5, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-12 16:05:23'),
(6, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-12 16:24:29'),
(7, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-12 16:25:55'),
(8, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-12 16:29:58'),
(9, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-13 14:15:18'),
(10, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-13 15:17:16'),
(11, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-13 15:32:54'),
(12, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-13 15:49:21'),
(13, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-13 15:52:58'),
(14, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-13 15:53:16'),
(15, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-20 13:06:25'),
(16, 'admin', 'DESKTOP-IE3UNEP', '127.0.0.1', 1, '2019-01-20 13:13:09');
...
INSERT INTO `ex_software` (`sw_id`, `sw_name`, `sw_status`, `sw_create`, `sw_update`, `sw_total`, `sw_type`) VALUES
(1, '1.75', 1, '2018-11-27 10:03:11', '2019-01-20 14:52:08', '230', 'ประเภทยางหน้า'),
(2, '2.50', 1, '2018-11-27 10:04:15', '2019-01-20 14:52:33', '30', 'ประเภทยางหลัง'),
(3, '2.75', 1, '2018-11-27 10:04:19', '2019-01-20 14:52:36', '25', 'ประเภทยางหน้า'),
(4, '3.00', 1, '2018-11-27 10:04:27', '2019-01-20 14:52:42', '100', 'ประเภทยางหลัง'),
(5, '3.25', 1, '2018-11-27 10:04:32', '2019-01-20 14:52:45', '75', 'ประเภทยางหน้า'),
(6, '3.75', 1, '2018-11-27 10:04:36', '2019-01-20 14:52:47', '80', 'ประเภทยางหลัง');
...
(2, '999999', 'Administrator', 'System', '999999.jpg', 'Administrator', 1, 'admin@test.com', '', '', '', 69, 1, '2018-11-19 11:35:15', '2019-01-20 16:25:31'),
...
--
-- Indexes for table `ex_customer`
--
ALTER TABLE `ex_customer`
...
--
-- AUTO_INCREMENT for table `ex_customer`
--
ALTER TABLE `ex_customer`
