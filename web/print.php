      ...
      <div class="col-sm-12 py-3">
        <form>
          ...
          <div class="form-group row">
            ...
            <input class="col-sm-6" value="<?php echo getServiceName($row['service_id']) ?>"></input>
          </div>
          ...
          <div class="form-group row">
            ...
            <input class="col-sm-9" value="<?php echo $row['req_text'] ?>"></input>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <input class="col-sm-4" value="<?php echo getStatusName($row['req_status']) ?>"></input>
          </div>
          <?php
