          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="text-center">จัดการอะไหล่</h5>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-xl-3 col-md-6 mb-2">
                    <select class="form-control form-control-sm"
                      ...
                      ?>
                      <option value="computers.php?dep=<?php echo $row['dep_id'] ?>" <?php if(@$_GET['dep'] == $row['dep_id']) echo 'selected' ?>><?php echo $row['dep_name'] ?></option>
                      <?php
                        endforeach;
                      ?>
                    </select>
                  ...
                  <div class="col-xl-3 col-md-6 mb-2">
                    <select class="form-control form-control-sm" name="sw_id[]" required>
                      <option value="">--- ค้นหา อะไหล่ ---</option>
                      <?php
                        $stmt = getSoftware();
                    ...
                    <div class="table-responsive">
                      <table id="data" class="table table-bordered table-hover table-sm">
                        ...
                        <tbody>
                          <?php
                            $getDep = @$_GET['dep'];
                            $result = getFilterComputer($getDep);
