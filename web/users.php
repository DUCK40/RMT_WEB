      ...
      <main role="main" class="col-xl-10 col-md-9 ml-sm-auto px-4">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="text-center">จัดการข้อมูลบุกคล</h5>
              </div>
              <div class="card-body">
              ...
              <?php  }
                ...
                <div class="row">
                  ...
                  <!-- <div class="col-xl-3 col-md-6 mb-2">
                    <a href="?act=add" class="btn btn-success btn-sm btn-block">
                      <i class="fas fa-plus mr-2"></i>เพิ่มบุกคล
                    </a>
                  </div> -->
                  ...
                  <div class="col-xl-3 col-md-6 mb-2">
                    <select class="form-control form-control-sm"
                      ...
                      <option value="users.php?dep="
                        <?php if(empty($_GET['dep'])) echo 'selected' ?>>--- ค้นหา สาขา ---</option>
                      <?php
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="text-center">แก้ไขข้อมูลผู้ใช้</h5>
              </div>
              <div class="card-body">
                    ...
                    <div class="form-check form-check-inline">
                      ...
                      <label class="form-check-label mx-3">
                        <input class="form-check-input" type="radio" name="user_level" value="69"
                          <?php if($row['user_level'] == '69') echo 'checked' ?>>ผู้จัดการสาขา
                      </label>
