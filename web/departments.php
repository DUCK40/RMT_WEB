      ...
      <main role="main" class="col-xl-10 col-md-9 ml-sm-auto px-4">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="text-center">จัดการข้อมูลสาขา</h5>
              </div>
              <div class="card-body">
                <!-- Button -->
                <?php
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="text-center">แก้ไขข้อมูลสาขา</h5>
              </div>
              <div class="card-body">
                    ...
                    <div class="form-check form-check-inline">
                      <label class="form-check-label mx-3">
                        <input class="form-check-input" type="radio" name="dep_status" value="1"
                          <?php if($row['dep_status'] == '1') echo 'checked' ?>>เปิดการใช้งาน
                      </label>
                      <label class="form-check-label mx-3">
                        <input class="form-check-input" type="radio" name="dep_status" value="2"
                          <?php if($row['dep_status'] == '2') echo 'checked' ?>>ปิดการใช้งาน
                      </label>
                    </div>
                  </div>
                  <div class="form-group row justify-content-center">
